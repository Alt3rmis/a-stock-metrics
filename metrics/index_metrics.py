...
def calculate_index_metrics(metrics: List[Dict]) -> Dict:
    """计算指数指标评分
...
def get_index_strength(metrics: List[Dict]) -> Dict:
    """获取指数强度评分
    ...
    Returns:
        Dict: 指数强度评分
    """
    return calculate_index_metrics(metrics)

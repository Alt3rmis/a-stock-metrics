...
def calculate_fund_metrics(metrics: List[Dict]) -> Dict:
    """计算资金指标评分
...
def get_fund_strength(metrics: List[Dict]) -> Dict:
    """获取资金强度评分
    ...
    Returns:
        Dict: 资金强度评分
    """
    return calculate_fund_metrics(metrics)
